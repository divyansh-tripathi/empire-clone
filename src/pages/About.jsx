      ...
      <div className="max-w-7xl mx-auto">
        <div className="overflow-hidden">
          <div className="flex flex-col md:flex-row items-center px-2">
            ...
            <div className="md:w-1/2 w-full h-[600px] md:h-[450px] relative shadow-xl border-8 border-white rounded-[30px] flex items-center justify-center" data-aos="fade-up">
              <img
